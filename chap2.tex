...
\begin{figure}[h]%
        \begin{center}%
         \pastefig{\FIGDIR/2.1.eps}{width=0.6\hsize}%
         \vspacebeforefig
    ...
    \fig{kaisei(zu).eps}{width=0.7\hsize}
